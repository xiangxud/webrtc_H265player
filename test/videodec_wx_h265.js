...
var wasmBinaryFile;
  wasmBinaryFile = 'videodec_wx_h265.wasm';
...
var ASM_CONSTS = {
  44600: ($0, $1) => { var isWorker = typeof importScripts == "function"; var bridge = (isWorker ? self : window)[UTF8ToString($0)]; if(bridge && typeof bridge["onVideoDataSize"] == "function"){ bridge["onVideoDataSize"]({ "size": $1, }); } },  
 44822: ($0, $1, $2, $3, $4, $5) => { var isWorker = typeof importScripts == "function"; var bridge = (isWorker ? self : window)[UTF8ToString($0)]; if(bridge && typeof bridge["onVideoData"] == "function"){ bridge["onVideoData"]({ "timestamp": $1, "width": $2, "height": $3, "stride0": $4, "stride1": $5 }); } },  
 45097: ($0) => { var isWorker = typeof importScripts == "function"; var bridge = (isWorker ? self : window)[UTF8ToString($0)]; if(bridge && typeof bridge["onComplete"] == "function"){ bridge["onComplete"](); } },  
 45294: ($0, $1, $2) => { var isWorker = typeof importScripts == "function"; var bridge = (isWorker ? self : window)[UTF8ToString($0)]; if(bridge && typeof bridge["onHeader"] == "function"){ bridge["onHeader"]({ "hasAudio": $1, "hasVideo": $2, }); } },  
 45522: ($0, $1) => { var isWorker = typeof importScripts == "function"; var bridge = (isWorker ? self : window)[UTF8ToString($0)]; if(bridge && typeof bridge["onMediaInfo"] == 'function'){ bridge["onMediaInfo"](UTF8ToString($1)); } },  
 45737: ($0, $1) => { var isWorker = typeof importScripts == "function"; var bridge = (isWorker ? self : window)[UTF8ToString($0)]; if(bridge && typeof bridge["onAudioDataSize"] == "function"){ bridge["onAudioDataSize"]({ "size": $1, }); } },  
 45959: ($0, $1) => { var isWorker = typeof importScripts == "function"; var bridge = (isWorker ? self : window)[UTF8ToString($0)]; if(bridge && typeof bridge["onAudioData"] == "function"){ bridge["onAudioData"]({ "timestamp": $1, }); } },  
 46178: ($0, $1) => { var isWorker = typeof importScripts == "function"; var bridge = (isWorker ? self : window)[UTF8ToString($0)]; if(bridge && typeof bridge["onVideoDataSize"] == "function"){ bridge["onVideoDataSize"]({ "size": $1, }); } },  
 46400: ($0, $1, $2, $3, $4, $5) => { var isWorker = typeof importScripts == "function"; var bridge = (isWorker ? self : window)[UTF8ToString($0)]; if(bridge && typeof bridge["onVideoData"] == "function"){ bridge["onVideoData"]({ "timestamp": $1, "width": $2, "height": $3, "stride0": $4, "stride1": $5 }); } },  
 46675: ($0) => { var isWorker = typeof importScripts == "function"; var bridge = (isWorker ? self : window)[UTF8ToString($0)]; if(bridge && typeof bridge["onComplete"] == "function"){ bridge["onComplete"](); } }
};
...
/** @type {function(...*):?} */
var _codecInit = Module["_codecInit"] = createExportWrapper("codecInit");

/** @type {function(...*):?} */
var _codecSetBridgeName = Module["_codecSetBridgeName"] = createExportWrapper("codecSetBridgeName");

/** @type {function(...*):?} */
var _codecSetAudioBuffer = Module["_codecSetAudioBuffer"] = createExportWrapper("codecSetAudioBuffer");

/** @type {function(...*):?} */
var _codecSetVideoBuffer = Module["_codecSetVideoBuffer"] = createExportWrapper("codecSetVideoBuffer");

/** @type {function(...*):?} */
var _codecDecode = Module["_codecDecode"] = createExportWrapper("codecDecode");

/** @type {function(...*):?} */
var _codecTry2Seek = Module["_codecTry2Seek"] = createExportWrapper("codecTry2Seek");

/** @type {function(...*):?} */
var _codecFree = Module["_codecFree"] = createExportWrapper("codecFree");
