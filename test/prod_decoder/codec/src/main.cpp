...
void codecInit(){//long videoCallback, long audioCallback, long requestCallback) {
  if (codec == nullptr) {
    printf("codecInit");
    codec = new Codec();
    // codec->videoCallback=(VideoCallback)videoCallback;
    // codec->audioCallback=(AudioCallback)audioCallback;
    // codec->requestCallback=(RequestCallback)requestCallback;
  }
}
// void codecSetCall() {
//    videoCallback;
